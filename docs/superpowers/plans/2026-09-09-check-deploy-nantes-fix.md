...
> **施工状态（2026-09-10）**：Task 1–5 + Task 6 Step 1 完工——6 commit 本地（`daaba9d6`/`cd803d8e`/`2698d89e`/`f61a3201`/`fdc4f81e`/`3d3f401f`），398 单测全绿，联网体检回绿 exit 0，opus 终审放行；正当偏离两处（`as`→类型标注、Task 4 实际修了 applyMatchFixes 吞场 bug）。Task 6 Steps 2–5 待 push 令。总司令令：本文档勾选留档不删。
...
- [x] **Step 4: 跑存量测试 + typecheck + build 确认零回归**
