...
describe('nationality-fill', () => {
  it('命中补齐：返回英文国名+ESPN旗', () => { expect(resolveFill(['Wang Yudong'],natMap,COUNTRY_MAP)).toEqual({citizenship:'China PR',flag:'https://a.espncdn.com/i/teamlogos/countries/500/chn.png'}) })
